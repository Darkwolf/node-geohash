...
const DEFAULT_GEOHASH_PRECISION = 10
const DEFAULT_GEOINT_BITS = 52
const DEFAULT_GEOBIGINT_BITS = 64
...
ObjectDefineProperties(Geohash, {
  ...
  DEFAULT_GEOHASH_PRECISION: {
    value: DEFAULT_GEOHASH_PRECISION
  },
  DEFAULT_GEOINT_BITS: {
    value: DEFAULT_GEOINT_BITS
  },
  DEFAULT_GEOBIGINT_BITS: {
    value: DEFAULT_GEOBIGINT_BITS
  },
  MIN_LATITUDE: {
    value: MIN_LATITUDE
  },
